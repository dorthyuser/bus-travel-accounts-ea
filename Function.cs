...
namespace GetAccountDetailsLambda
{
    public class Function
    {
        ...
        public async Task<APIGatewayProxyResponse> FunctionHandler(APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            context.Logger.LogLine($"START - GetAccountDetails - X_CORRELATION_ID:{correlationId}");
            ...
            try
            {
                ...
                using var httpRequest = new HttpRequestMessage(HttpMethod.Get, $"/accounts/{Uri.EscapeDataString(accountId)}");
