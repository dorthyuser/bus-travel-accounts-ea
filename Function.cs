    ...
    public class Function
    {
        ...
        public async Task<APIGatewayProxyResponse> FunctionHandler(APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            try
            {
                ...
                if (request.PathParameters != null && request.PathParameters.TryGetValue("id", out var idv))
                    accountId = idv?.Trim();
                ...
                string requestUri = basePath.TrimEnd('/') + "/accounts/" + Uri.EscapeDataString(accountId ?? string.Empty);
                ...
                context.Logger.LogLine($"Before Request - bus-travel-accounts-sa-update-account, url={requestUri}");
